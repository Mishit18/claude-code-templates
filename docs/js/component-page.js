...
class ComponentPageManager {
    ...
    async loadComponentsMarketplace() {
        try {
            ...
            const marketplaceResponse = await fetch('https://raw.githubusercontent.com/mishit18/claude-code-templates/main/cli-tool/components/.claude-plugin/marketplace.json');
    ...
    loadGiscusComments() {
        ...
        script.setAttribute('data-repo', 'mishit18/claude-code-templates');
    ...
    generateGitHubURL() {
        let githubUrl = 'https://github.com/mishit18/claude-code-templates/';
