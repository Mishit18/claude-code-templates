...
This project is maintained by Mishit Sharma.
...
### Email
Send details of the vulnerability via the repository's security contact with the subject line "SECURITY: Claude Code Templates Vulnerability Report"

### GitHub Security Advisories
You can also report vulnerabilities through [GitHub Security Advisories](https://github.com/mishit18/claude-code-templates/security/advisories/new) for this repository.
...
- **Maintainer**: Mishit Sharma
- **GitHub**: Repository maintainer contact
